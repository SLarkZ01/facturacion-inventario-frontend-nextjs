...
const RegisterSchema = z
  .object({
    username: z.string().min(3, { message: "Usuario muy corto" }),
    email: z.string().email({ message: "Email inválido" }),
    password: z.string().min(6, { message: "Contraseña muy corta" }),
    confirmPassword: z.string().min(6, { message: "Confirmar contraseña" }),
...
const Form = () => {
  ...
  async function onSubmit(values: RegisterValues) {
    try {
      ...
      push({ title: "Cuenta creada", description: "Ahora puedes iniciar sesión" });
      router.push("/login");
    } catch {
        ...
        <div className="right">
          <form className="form" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="inputForm">
              ...
              <input {...register("username")} placeholder="Ingresa tu usuario" className="input" type="text" />
            </div>
            ...
            <div className="flex-row-names">
              <div className="flex-column">
                <label>Nombre</label>
                <div className="inputForm">
                  <input {...register("nombre")} placeholder="Tu nombre" className="input" type="text" />
                </div>
              ...
              <div className="flex-column">
                ...
                <div className="inputForm">
                  <input {...register("apellido")} placeholder="Tu apellido" className="input" type="text" />
                </div>
            ...
            <div className="inputForm">
              ...
              <input {...register("email")} placeholder="Ingresa tu email" className="input" type="email" />
            </div>
            ...
            <div className="inputForm relative">
              ...
              <input {...register("password")} placeholder="Ingresa tu contraseña" className="input" type={showPassword ? 'text' : 'password'} />
              <button
                type="button"
            ...
            <div className="inputForm relative">
              ...
              <input {...register("confirmPassword")} placeholder="Confirma tu contraseña" className="input" type={showConfirmPassword ? 'text' : 'password'} />
              <button
                type="button"
            ...
            <div className="inputForm">
              <input {...register("inviteCode")} placeholder="Código de invitación" className="input" type="text" />
            </div>

            <button className="button-submit" type="submit" disabled={isSubmitting}>
              {isSubmitting ? 'Creando cuenta...' : 'Crear cuenta'}
            </button>
            <p className="p">¿Ya tienes una cuenta? <Link href="/login" className="span">Inicia sesión</Link></p>
